...
## 7-Steps
1. Determine Model/Factor Significance: The application will output the ANOVA table and Pareto Chart of Effects to allow users to select their significant factors and interactions
